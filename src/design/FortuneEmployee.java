...
public class FortuneEmployee {
	...
	public static void main(String[] args) {
		...
		EmployeeInfo employee1 = new EmployeeInfo(001,"Achillis","Sales");
		EmployeeInfo employee2 = new EmployeeInfo(002,"Hector","Marketing");
		EmployeeInfo employee3 = new EmployeeInfo(003,"Afrodite","Useless");
		EmployeeInfo employee4 = new EmployeeInfo(004,"Pryam ","Useless");
		EmployeeInfo employee5 = new EmployeeInfo(001,"Agamemnon","Accounts");
